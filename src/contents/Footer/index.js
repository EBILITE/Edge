                ...
                <div class="footer-items footer-ul">
                    <div class="foota">
                        <ul class="footer-links">
                            <li class="Fsocials"><a href="#"><img src={facebook} alt="" /></a></li>
                            <li class="Fsocials"><a href="#"><img src={twitter}  alt=""/></a></li>
                            <li class="Fsocials"><a href="#"><img src={linkedin} alt="" /></a></li>
                            <li class="Fsocials"><a href="#"><img src={vector3}  alt=""/></a></li>
                        </ul>
